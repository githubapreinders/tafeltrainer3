...
public class FeedbackPage extends Composite
{
	...
	public FeedbackPage(MainView main, FeedbackContainer fiba, tafeltrainer3messages messages)
	{
		...
		this.flex1.getCellFormatter().setWidth(1, 0, "480px");
		...
		flex10.getFlexCellFormatter().setWidth(0, 0, "160px");
		flex10.getFlexCellFormatter().setWidth(0, 1, "160px");
		flex10.getFlexCellFormatter().setWidth(0, 2, "160px");
		this.spanel1.setHeight("365px");
		this.spanel1.setWidth("480px");
		spanel1.add(flex10);
		this.flex1.setWidget(1, 0, spanel1);

		// tweede rij, kolom met awards
		flex11 = new FlexTable();
		flex11.getFlexCellFormatter().setWidth(0, 0, "160px");
		flex11.getFlexCellFormatter().setWidth(0, 1, "160px");
		flex11.getFlexCellFormatter().setWidth(0, 2, "160px");
		flex11.setBorderWidth(0);
		this.spanel2 = new ScrollPanel();
		this.spanel2.setHeight("365px");
		this.spanel2.setWidth("480px");
