...
public class Devicetype extends Composite
{
	...
	public void initializeGui(ClientImp client, MainView main, tafeltrainer3messages messages)
	{
		this.client = client;
		this.main = main;
		...
		numpad = new NumPadWidget(Devicetype.this);
		this.flex1.getFlexCellFormatter().setVerticalAlignment(0, 2, HasVerticalAlignment.ALIGN_BOTTOM);
